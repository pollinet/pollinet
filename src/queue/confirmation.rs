...
impl Confirmation {
    ...
    pub fn success(original_tx_id: [u8; 32], signature: String) -> Self {
        Self::new(original_tx_id, ConfirmationStatus::Success { signature })
    }

    /// Create new failure confirmation
    pub fn failure(original_tx_id: [u8; 32], error: String) -> Self {
        Self::new(original_tx_id, ConfirmationStatus::Failed { error })
    }
...
mod tests {
    ...
    fn test_queue_full_drops_oldest() {
        ...
        queue
            ...
            .unwrap();
        queue
            .push(Confirmation::success([2u8; 32], "sig2".to_string()))
            .unwrap();

        // Queue full, should drop oldest
        assert!(queue
            .push(Confirmation::success([3u8; 32], "sig3".to_string()))
            .is_ok());
    ...
    fn test_stats() {
        ...
        queue
            ...
            .unwrap();
        queue
            .push(Confirmation::failure([2u8; 32], "error".to_string()))
            .unwrap();
